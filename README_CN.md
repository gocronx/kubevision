<div align="center">
  ...
  <p>
    <a href="https://go.dev"><img src="https://img.shields.io/badge/Go-1.26.6-00ADD8?style=flat-square&logo=go&logoColor=white" alt="Go"></a>
...
- **Helm 工作区**：快捷部署 PostgreSQL、Redis 或 gocron，浏览其他 Chart，并将受控安装、升级、回滚和移除作为可恢复的后台操作执行
- **安全与访问控制**：5 种内置 RBAC 角色、TOTP 双因素认证和异步审计日志
- **高度可扩展**：内置 26 种以上资源，并可在运行时自动发现 CRD
- **现代化界面**：适配桌面端与移动端操作流程，并提供完整国际化支持和原生暗色模式
...
```bash
# 1. 从公开 OCI Registry 安装 KubeVision
